...
- 飞书、QQ、OpenClaw 的提醒由 OpenClaw 自己执行，平台不负责把提醒发出去。
...
这一步只影响 OpenClaw 自己的提醒方式，不影响平台主链。
...
这里只要记住：
- 平台只负责记录推荐结果和平台内私信
- 用户是否开启主动推送、推到哪里，由 OpenClaw 自己记住
